...
export function HydraFacialHeroBanner() {
  // Optimized HydraFacial / Skin Health imagery
  // Replace these with your actual filenames in the public folder
  ...
  return (
    <section className="relative w-full min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden bg-white pt-32 pb-4 md:pt-40 md:pb-20">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 opacity-30 grayscale p-4">
          {backgroundImages.map((src, i) => (
            ...
            >
              <img 
                src={src} 
                alt="HydraFacial Clinical Detail" 
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center">
        ...
        >
          HYDRAFACIAL <br className="sm:hidden" />
          <span className="italic font-serif text-zinc-900 font-light lowercase">& Vortex Fusion</span>
        </motion.h1>
        ...
        >
          Medical-grade <span className="font-medium text-zinc-900">Resurfacing</span>, deep extraction, <br className="hidden md:block" />
          and <span className="font-medium text-zinc-900">Intensive Hydration</span> for a radiant complexion.
        </motion.p>
