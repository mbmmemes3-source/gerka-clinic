  ...
  return (
    <section className="relative w-full min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden bg-white pt-32 pb-4 md:pt-40 md:pb-20">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 opacity-30 grayscale p-4">
          {backgroundImages.map((src, i) => (
            ...
            >
              <img 
                src={src} 
                alt="Regenerative Hair Treatment Detail" 
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center">
        ...
        >
          HAIR LOSS <br className="sm:hidden" />
          <span className="italic font-serif text-zinc-900 font-light lowercase">& Regenerative</span>
        </motion.h1>

        {/* Updated Sub-description based on your SEO data */}
        <motion.p 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          Advanced regenerative treatments for <span className="font-medium text-zinc-900">androgenetic hair loss</span> <br className="hidden md:block" />
          including <span className="font-medium text-zinc-900">PRP, Dutasteride</span> injections and vitamin complexes.
        </motion.p>
